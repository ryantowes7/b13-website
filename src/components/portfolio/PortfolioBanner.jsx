    ...
    <section className="relative h-[400px] overflow-hidden group">
      ...
      {banners.map((banner, index) => (
        ...
        >
          ...
          <div className={`relative h-full container-custom flex ${getVerticalAlignment(banner.text_position?.vertical)} ${getHorizontalAlignment(banner.text_position?.horizontal)}`}>
            <div className={`max-w-3xl text-white ${getTextAlignment(banner.text_position?.text_align)}`}>
              ...
              <div 
                className={`text-white/90 leading-relaxed prose prose-invert max-w-none prose-p:mb-4 prose-p:leading-relaxed prose-ul:my-4 prose-ul:space-y-2 prose-li:my-2 prose-li:leading-relaxed ${getSubtitleSize(banner.text_position?.subtitle_size)}`}
